...
The treasury is key to supporting strategic investments to improve UX for stakeholders, effectively manage protocol security, and fund other capital and resource needs for this exciting phase of the project. As of now, the onchain treasury is again not accumulating LPT, having hit the "treasury ceiling" and reset the treasury reward cut to 0%.

This is the same mechanism that prompted [LIP-101](LIP-101.md), which restarted the treasury reward cut at 10% after the ceiling was previously reached.
...
Consistent with [LIP-101](LIP-101.md), and with no discussion in favour of changing the parameter, we propose to restart round-based treasury rewards at 10%. This is the same rate applied throughout the life of the onchain treasury.
